...
class ThemeOptionRepository
{
    ...
    public function saveThemeOption($request)
    {
        ...
        switch ($option_name) {
            ...
            case 'custom_css':
                ...
                $path = base_path('/themes/tlcommerce/public/css/custom_css.css');
                if(file_exists($path)){
                    unlink($path);
                }
    ...
    public function setBlogStyle()
    {
        ...
        $path = base_path('themes/tlcommerce/public/css/blog.css');
        setFolderPermissions($path);
    ...
    public function setSidebarOptionStyle()
    {
        ...
        $path = base_path('themes/tlcommerce/public/css/sidebar_options.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function set404PageStyle()
    {
        ...
        $path = base_path('themes/tlcommerce/public/css/page_404.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setFooterStyle()
    {
        ...
        $path = base_path('themes/tlcommerce/public/css/footer.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setBackToTopStyle()
    {
        ...
        $path = base_path('themes/tlcommerce/public/css/back_to_top.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    /**
    ...
    public function setSocialIconStyle()
    {
        ...
        $path = base_path('themes/tlcommerce/public/css/social_icon.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setHeaderOptionsStyle()
    {
        ...
        $path = base_path('themes/tlcommerce/public/css/header.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setHeaderLogosStyle()
    {
        ...
        $path = base_path('themes/tlcommerce/public/css/header_logo.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setHeaderMenuStyle()
    {
        ...
        $path = base_path('themes/tlcommerce/public/css/menu.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setNewsletterStyle()
    {
        ...
        $path = base_path('themes/tlcommerce/public/css/subscribe.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function resetThemeOption($request)
    {
        ...
        if ($request->submitType == 'reset_section') {
            $path = base_path('themes/tlcommerce/public/css/'.$request->option_name.'.css');
            if(file_exists($path)){
                unlink($path);
            }
            fopen($path, 'w');
        ...
        if ($request->submitType == 'reset_all') {
            for ($i=0; $i < sizeof($themeOptionCssFile); $i++) { 
                $path = base_path('themes/tlcommerce/public/css/'.$themeOptionCssFile[$i].'.css');
                if(file_exists($path)){
                    unlink($path);
                }
                fopen($path, 'w');
    ...
    {
        $active_theme = getActiveTheme();
        $location = 'themes/tlcommerce/public/';

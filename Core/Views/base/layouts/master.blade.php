        ...
        <div class="main-wrapper">
            ...
            <div class="main-content">
                <div class="container-fluid">
                    @if (systemUpdateAvailability())
                        <div class="alert alert-success align-items-center d-flex justify-content-between">
                            <p class="mb-0"> System update is available. Please update your system.</p>
                            <a href="{{ route('core.check.update') }}" class="btn sm">Update Now</a>
                        </div>
                    @endif

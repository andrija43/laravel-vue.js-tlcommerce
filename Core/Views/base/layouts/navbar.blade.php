<nav class="sidebar" data-trigger="scrollbar">
    ...
    <div class="sidebar-body main-side-bar">
        ...
        <ul class="nav" id="main-nav">
            ...
            @foreach (plugingsNavbar() as $item)
                @includeIf($item)
            @endforeach
            ...
            <!--Manage System Updater-->
            <li class="{{ Request::routeIs(['core.check.update']) ? 'active' : '' }}">
                <a href="{{ route('core.check.update') }}">
                    <i class="icofont-wrench"></i>
                    <span class="link-title">{{ translate('System Updater') }}</span>
                </a>
            </li>
            <!--End Manage System Updater-->
        </ul>
        <!-- End Nav -->
    </div>
    <!-- End Sidebar Body -->
